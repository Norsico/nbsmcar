...
/************ 宏定义 ************/
#define TICKS_MS 1                     // 系统 tick 1ms
#define KEY_SCAN_PERIOD 20             // 按键扫描周期 20ms (50Hz)
#define BUZZER_PERIOD 20               // 蜂鸣器轮询周期 20ms
#define LASER_PERIOD 1                 // 激光笔轮询周期 1ms，用于短脉冲自动关断
#define IMU_PERIOD 10                  // IMU 读取周期 10ms (100Hz)
#define STEER_PERIOD 10                // 舵机控制周期 10ms
#define ENCODER_PERIOD 10              // 编码器采样周期 10ms (100Hz)
#define CENTER_PERIOD 16               // 图像处理周期 16ms
...
extern vuint32 g_laser_ticks;          // 激光笔计时器
