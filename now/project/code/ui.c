...
#define UI_ROW_H                     (16)  //����ÿ�� y ���
#define UI_NAME_X                    (16)  //�������� x λ��
#define UI_VALUE_X                   (144) //�������� x λ��
...
// ���������˵�������
typedef struct {
    const char *name;     // UI ����ʾ������
    void *val_ptr;        // ָ����ʵ�������ڴ��ַ
    var_type_e type;      // ����ʵ����������
    int16 step;           // ÿ�ΰ�����/���Ĳ���
} ui_param_t;
...
static uint8 UiSelect = 0;//����ѡ��״̬
static uint8 UiEdit = 0;//�༭״̬
static uint8 UiDebugGray = 0;//��ʾ��ֵ�����ǻҶ�
static uint8 UiPowerPercent;//��ذٷֱ�
