...
static void ui_show_camera_image(void)
{
    ...
    } else if(Image.ring == 2) {
        ips200_show_string(112, 140, "R");
    } else {
        ips200_show_string(112, 140, "-");
    }
    ips200_show_string(128, (uint16)(140), "s");
    ips200_show_uint8(144, (uint16)(140), Image.ring_step);
    ips200_show_string(176, (uint16)(140), Image.zebra ? "Z" : "z");
    ips200_show_uint8(192, (uint16)(140), Image.zebra_count);
