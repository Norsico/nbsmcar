...
uint16 ccd_data_ch3[128];                       //CCD数据通道2
//-------------------------------------------------------------------------------------------------------------------
...
void ccd_init(void)     
{       
    adc_init(AD_CHANNEL_CH1,0X00);
    adc_init(AD_CHANNEL_CH2,0X00);    
//    adc_init(AD_CHANNEL_CH3,0X00); 	 //三ccd
...
//			ccd_data_ch3[i] = adc_once(AD_CHANNEL_CH3, AD_RESOLUTION);
			CCD_CLK(1); 
    }
