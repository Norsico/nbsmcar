...
IFX_INTERRUPT(cc60_pit_ch1_isr, 0, CCU6_0_CH1_ISR_PRIORITY)
{
    ...
    //adccollect();
    SteerPID_Realize(ImageStatus.Det_True - 39);//舵机位置式PID
...
IFX_INTERRUPT(cc61_pit_ch0_isr, 0, CCU6_1_CH0_ISR_PRIORITY)
{
    interrupt_global_enable(0);                     // 开启中断嵌套
    speed_measure();//电机控制
//    pwm_set_duty(ATOM1_CH3_P21_5,1500);//正转
//    pwm_set_duty(ATOM0_CH1_P21_3,1500); //正转
...
//    gyro_data();   //陀螺仪数据获取
//    dl1a_get_distance();    //tof返回值           后面装上之后再显示
