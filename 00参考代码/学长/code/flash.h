...
//=====================================================软件 IIC 驱动====================================================
#define AT24C02_SCL_PIN            (P33_8)            // 软件 IIC SCL 引脚 连接 AT24C02 的 SCL 引脚
#define AT24C02_SDA_PIN            (P33_6)            // 软件 IIC SDA 引脚 连接 AT24C02 的 SDA 引脚
#define AT24C02_SOFT_IIC_DELAY     (1000 )            // 软件 IIC 的时钟延时周期 数值越小 IIC 通信速率越快
//=====================================================软件 IIC 驱动====================================================
