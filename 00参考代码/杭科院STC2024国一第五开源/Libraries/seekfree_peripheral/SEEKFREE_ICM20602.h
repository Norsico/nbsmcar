...
//=====================================================软件 IIC 驱动====================================================
	#define ICM20602_SCL_PIN   		P47				// 软件 IIC SCL 引脚spc
	#define ICM20602_SDA_PIN  		P14				// 软件 IIC SDA 引脚
	#define ICM20602_SOFT_IIC_DELAY	(0)
//=====================================================软件 IIC 驱动====================================================
#else
//=====================================================软件 SPI 驱动====================================================
	#define ICM20602_SPC_PIN        (P47)			// 软件 SPI SCK 引脚
	#define ICM20602_SDI_PIN        (P14)          	// 软件 SPI MOSI 引脚
	#define ICM20602_SDO_PIN        (P15)			// 软件 SPI MISO 引脚
